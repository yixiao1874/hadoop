...
public class JavaRecommendationExample {
    public static void main(String args[]) {
        ...
        String path = "file:///usr/input/test.dat";
        ...
        for(int i=0;i<recommendations.length;i++){
            ...
            /*byte[] bytexml = (recommendations[i].product()+"").getBytes();

            try {
                OutputStream os = new FileOutputStream(new File("/usr/output/output.dat"),true);
                os.write(bytexml);
                os.flush();
                os.close();
